...
const sidebars: SidebarsConfig = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        'advanced-apis/post-training',
        'advanced-apis/evaluation', 
        'advanced-apis/scoring',
      ],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: [
        'contributing/index',
        'contributing/new-api-provider',
        'contributing/new-vector-database',
    ...
    },
    {
      ...
      items: [
        'references/index',
        'references/llama-cli',
        'references/client-cli',
        'references/python-sdk',
        'references/evals-reference',
      ],
    },
  ...
  apiSidebar: [
    ...
    },
    {
      ...
      items: require('./docs/api/sidebar.ts').default, // Generated by OpenAPI plugin
    }
  ],
};
